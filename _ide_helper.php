...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function mergeOrderSessionData($token, $data)
        {
                        /** @var \Botble\Ecommerce\Supports\OrderHelper $instance */
                        return $instance->mergeOrderSessionData($token, $data);
        }
                    /**
         * 
         *
...
namespace  { 
             ...
             * @static 
             */ 
            public static function getBalanceAttribute(...$args)
            {
                                return \Illuminate\Database\Eloquent\Builder::getBalanceAttribute(...$args);
            }
             ...
             * @static 
             */ 
            public static function getBankInfoAttribute(...$args)
            {
                                return \Illuminate\Database\Eloquent\Builder::getBankInfoAttribute(...$args);
            }
             ...
             * @static 
             */ 
            public static function getTotalFeeAttribute(...$args)
            {
                                return \Illuminate\Database\Eloquent\Builder::getTotalFeeAttribute(...$args);
            }
             ...
             * @static 
             */ 
            public static function getTotalRevenueAttribute(...$args)
            {
                                return \Illuminate\Database\Eloquent\Builder::getTotalRevenueAttribute(...$args);
            }
